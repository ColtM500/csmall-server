-- mall_ams：Administrator Management System
...
VALUES (1, 'root', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '系统管理员',
       ...
       (3, 'qilei', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '齐雷老师',
        ...
        'qilei@baidu.cn', '齐雷老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (4, 'wangkejing', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '克晶老师',
        'https://tupian.qqw21.com/article/UploadPic/2021-7/20217821572211826.jpeg', '13900139004', 'wangkejing@baidu.com',
        '王克晶老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (5, 'fanchuanqi', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '传奇老师',
        ...
        'fanchuanqi@baidu.com', '范传奇老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (6, 'liuguobin', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '国斌老师',
        ...
        'liuguobin@baidu.com', '刘国斌老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (7, 'chengheng', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '成恒老师',
        ...
        'chengheng@baidu.com', '成恒老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (8, 'zhanghaolan', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '晧岚老师',
        ...
        'zhanghaolan@baidu.com', '张晧岚老师的账号', 1, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (9, 'wanghaitao', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '海涛老师',
        ...
        'wanghaitao@baidu.com', '王海涛老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (10, 'zhangjiujun', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '久军老师',
        ...
        'zhangjiujun@baidu.com', '张久军老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (11, 'xiaoxuwei', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '旭伟老师',
        ...
        'xiaoxuwei@baidu.com', '肖旭伟老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (12, 'zhaoxiujia', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '秀佳老师',
        ...
        'zhaoxiujia@baidu.com', '赵秀佳老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (13, 'lidashuai', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '大帅老师',
        ...
        'lidashuai@baidu.com', '李大帅老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44'),
       (14, 'zhangyaoyun', '$2a$10$N.ZOn9G6/YLFixAOPMg/h.z7pCu6v2XyFDtC4q.jeeGm/TEZyj15C', '耀匀老师',
        ...
        'zhangyaoyun@baidu.com', '张耀匀老师的账号', 0, NULL, 0, NULL, '2022-07-08 11:30:44', '2022-07-08 11:30:44')
;
...
VALUES (1, '后台管理-管理员-读取', '/ams/admin/read', '读取管理员信息，含查看列表、查看详情，及其它查询操作', 255, '2022-07-08 11:30:44',
       ...
       (8, '后台管理-商品-修改', '/pms/product/update', '修改商品信息，含商品相关的所有数据的修改操作，含所有修改操作', 96, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (9, '后台管理-品牌-读取', '/pms/brand/read', '读取品牌信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ...
       (12, '后台管理-品牌-修改', '/pms/brand/update', '修改品牌信息，含修改基本资料、启用、禁用，及其它修改操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (13, '后台管理-类别-读取', '/pms/category/read', '读取类别信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ...
       (16, '后台管理-类别-修改', '/pms/category/update', '修改类别信息，含修改基本资料、启用、禁用，及其它修改操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       (17, '后台管理-图片-读取', '/pms/picture/read', '读取图片信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
       ...
       (21, '后台管理-相册-读取', '/pms/album/read', '读取相册信息，含查看列表、查看详情，及其它查询操作', 0, '2022-07-08 11:30:44',
        '2022-07-08 11:30:44'),
